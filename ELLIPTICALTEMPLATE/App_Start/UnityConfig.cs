...
namespace EllipticalTemplate
{
    ...
    public class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<ISmsService, TwilioSmsService>();
            ...
            container.RegisterType<ILoginProfileViewModel, LoginProfileViewModel>();


            //web api controller registrations
